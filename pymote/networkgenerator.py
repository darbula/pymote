...
class NetworkGenerator:
    ...
    def generate_random_network(self):
        ...
        logger.error("Could not generate connected network with %d nodes.\n"
                     ...
                     self.n_count)
        # TODO: increase comm_range to value big enough for connected network
        return None
    ...
    def generate_degree_network(self):
        ...
        while i < 10:
            ...
            while not len(net.nodes()) or average(net.degree().values()) < \
                      self.degree and len(net.nodes()) < self.n_max:
                net.add_node()
                logger.debug('Current degree %f.' %
                             average(net.degree().values()))
